package com.retorfit.library.config;

import android.content.Context;
import android.text.TextUtils;
import com.retorfit.library.cookie.CookieJarImpl;
import com.retorfit.library.cookie.store.CookieStore;
import com.retorfit.library.interceptor.*;
import com.retorfit.library.interfaces.IHeadersListener;
...
public class OkHttpConfig {
    ...
    public static class Builder {
        ...
        private IHeadersListener headersListener;
        ...
        public Builder setHeaders(IHeadersListener headersListener) {
            ...
            if (headersListener != null) {
                okHttpClientBuilder.addInterceptor(new HeaderInterceptor() {
                    ...
                    public Map<String, String> buildHeaders() {
                        return headersListener.addHeaders();
                    }
                });
            }
