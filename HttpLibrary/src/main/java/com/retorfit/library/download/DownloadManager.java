...
public class DownloadManager {
    ...
    public File saveFile(ResponseBody response, String destFileName, String destFileDir, ProgressListener progressListener) throws IOException {
        if (TextUtils.isEmpty(destFileDir)) throw new RuntimeException("下载路径不能为空");
        ...
        try {
            ...
            while ((len = is.read(buf)) != -1) {
                ...
                progressListener.onResponseProgress(finalSum, contentLength, (int) ((finalSum * 1.0f / contentLength) * 100),
